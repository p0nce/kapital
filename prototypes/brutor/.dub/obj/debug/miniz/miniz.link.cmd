...
"C:\Program Files (x86)\VisualD\pipedmd.exe" -deps obj\debug\miniz\miniz.lnkdep ldc2 -lib -oq -od="obj\debug\miniz" -m64 -g -d-debug -op -w -I="C:\Users\guill\AppData\Local\dub\packages\miniz\0.0.3\miniz\source" -d-version=encodePNG -d-version=decodeJPEG -d-version=decodePNG -d-version=decodeQOI -d-version=decodeQOIX -d-version=decodeSQZ -d-version=Have_miniz -of=lib\miniz.lib C:\Users\guill\AppData\Local\dub\packages\miniz\0.0.3\miniz\source\miniz.obj
if %errorlevel% neq 0 goto reportError
if not exist lib\miniz.lib (echo lib\miniz.lib not created! && goto reportError)
