...
"C:\Program Files (x86)\VisualD\pipedmd.exe" -deps obj\debug\godot-math\godot-math.lnkdep ldc2 -lib -oq -od="obj\debug\godot-math" -m64 -g -d-debug -op -w -I="C:\Users\guill\AppData\Local\dub\packages\godot-math\0.0.5\godot-math\source" -I="C:\Users\guill\AppData\Local\dub\packages\numem\1.6.5\numem\source" -d-version=Have_godot_math -d-version=Have_numem -of=lib\godot-math.lib C:\Users\guill\AppData\Local\dub\packages\godot-math\0.0.5\godot-math\source\godotmath.obj
if %errorlevel% neq 0 goto reportError
if not exist lib\godot-math.lib (echo lib\godot-math.lib not created! && goto reportError)
