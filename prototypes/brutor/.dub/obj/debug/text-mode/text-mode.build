...
echo C:\Users\guill\AppData\Local\dub\packages\text-mode\1.1.16\text-mode\source\rectlist.d >obj\debug\text-mode\text-mode.build.rsp
echo C:\Users\guill\AppData\Local\dub\packages\text-mode\1.1.16\text-mode\source\textmode.d >>obj\debug\text-mode\text-mode.build.rsp

"C:\Program Files (x86)\VisualD\pipedmd.exe" -deps obj\debug\text-mode\text-mode.dep ldc2 -m64 -g -d-debug -op -w -X -Xf="obj\debug\text-mode\text-mode.json" -I="C:\Users\guill\AppData\Local\dub\packages\text-mode\1.1.16\text-mode\source" -I="C:\Users\guill\AppData\Local\dub\packages\intel-intrinsics\1.14.2\intel-intrinsics\source" -I="C:\Users\guill\AppData\Local\dub\packages\miniz\0.0.3\miniz\source" -d-version=Have_text_mode -d-version=Have_intel_intrinsics -d-version=Have_miniz -d-version=encodePNG -d-version=decodeJPEG -d-version=decodePNG -d-version=decodeQOI -d-version=decodeQOIX -d-version=decodeSQZ -c -od=obj/debug/text-mode @obj\debug\text-mode\text-mode.build.rsp
